...
\tcbset{
  ...
  colframe=tcb_title_bg,colback=tcb_content_bg,coltitle=teal-7,
  title style=tcb_title_bg,
  bottomrule=1pt,%  <-- reserve space
  borderline south={1pt}{0pt}{tcb_title_bg},%---- draw line
  capture=minipage,
